drinkon.factory('dbRepository', function($http)
{
  return {
    ...
    getVendorLocation: function(_vendor_id, cb)
    {
	  var url = "" + sysconfig["web_protocol"] + "://" + sysconfig["svc_url_base"] + "/svc_data.php?v=GET&q=dv_sys_vendor_location&s1=id&s2=" + _vendor_id + ""
    ...
    getVendorOpeningHours: function(_vendor_id, cb)
    {
	  var url = "" + sysconfig["web_protocol"] + "://" + sysconfig["svc_url_base"] + "/svc_data.php?v=GET&q=dv_sys_vendor_opening_hours&s1=vendor_id&s2=" + _vendor_id + ""
    ...
    getVendorRolesList: function(_vendor_id, cb)
    {
	  var url = "" + sysconfig["web_protocol"] + "://" + sysconfig["svc_url_base"] + "/svc_data.php?v=GET&q=dv_sys_user_roles&s1=vendor_id&s2=" + _vendor_id + ""
    ...
    getVendorRoleDetails: function(_id, cb)
    {
	  var url = "" + sysconfig["web_protocol"] + "://" + sysconfig["svc_url_base"] + "/svc_data.php?v=GET&q=dv_sys_user_roles&s1=id&s2=" + _id + ""
    ...
    getOpeningHours: function(cb)
    {
	  var url = "" + sysconfig["web_protocol"] + "://" + sysconfig["svc_url_base"] + "/svc_data.php?v=GET&q=dv_sys_opening_hours"
